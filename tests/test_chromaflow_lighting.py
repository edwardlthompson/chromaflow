...
class LightingHidTests(unittest.TestCase):
    def test_ui_lists_hid_and_prompt(self) -> None:
        ...
        self.assertIn("lighting.modulesPrompt", locales)
        self.assertIn("lighting.kind.motherboard", locales)
        ...
        self.assertIn("lighting.protocol", locales)
        ...
        self.assertNotIn("researchHelp", research)
        ...
        locales = (ROOT / "apps/desktop/src/locales/en.json").read_text(encoding="utf-8")
        self.assertIn("lighting.apply", locales)
        ...
        self.assertIn("lighting.fusionSame", locales)
        self.assertIn("aria-description", row)
        self.assertIn("tools-rest", wheel)
        self.assertIn("repeat(8, minmax(0, 1fr))", (ROOT / "apps/desktop/src/app.css").read_text(encoding="utf-8"))
        ...
        self.assertIn("lighting.settings", locales)
        ...
        devices = (ROOT / "apps/desktop/src/lib/DeviceList.svelte").read_text(encoding="utf-8")
        self.assertIn("layout-toggle", devices)
        ...
        self.assertIn("calc(var(--picker-size) * 4)", css)
        ...
        self.assertIn("tools-apply", (ROOT / "apps/desktop/src/lib/DeviceList.svelte").read_text(encoding="utf-8"))
    ...
    def test_udev_is_per_vid_not_blanket_hidraw(self) -> None:
        ...
        self.assertIn("lighting.viaHint", locales)
        self.assertIn("lighting.noBackend", locales)
