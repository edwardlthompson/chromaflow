...
class SupportDryRunTests(unittest.TestCase):
    ...
    def test_policy_and_apply_are_one_click(self) -> None:
        ...
        self.assertIn('t["support.installAll"]', (ROOT / "apps/desktop/src/pages/Support.svelte").read_text(encoding="utf-8"))
        self.assertIn("runApply()", (ROOT / "apps/desktop/src/pages/Support.svelte").read_text(encoding="utf-8"))
        self.assertIn("failLines", (ROOT / "apps/desktop/src/pages/Support.svelte").read_text(encoding="utf-8"))
...
""",
    ...
    def test_competitors_uninstall_plan_is_dry_run(self) -> None:
        ...
        self.assertIn("confirmTakeover", page)
